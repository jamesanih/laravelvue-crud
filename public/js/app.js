          ...
          _c("div", { staticClass: "page-body" }, [
            _c("div", { staticClass: "row" }, [
              _c("div", { staticClass: "col-md-6 col-xl-3" }, [
                _c(
                  "div",
                  { staticClass: "card client-blocks dark-primary-border" },
                  [
                    _c("router-link", { attrs: { to: "/jobs", exact: "" } }, [
                      _c("a", [
                        _c("div", { staticClass: "card-block" }, [
                          _c("h5", [_vm._v("Total Jobs")]),
                          _vm._v(" "),
                          _c("ul", [
                            _c("li", [
                              _c("i", {
                                staticClass: "icofont icofont-document-folder"
                              })
                            ]),
                            _vm._v(" "),
                ...
                _c(
                  ...
                  [
                    _c("router-link", { attrs: { to: "/users" } }, [
                      _c("a", [
                        _c("div", { staticClass: "card-block" }, [
                          _c("h5", [_vm._v("Total Users")]),
                          _vm._v(" "),
                          _c("ul", [
                            _c("li", [
                              _c("i", {
                                staticClass: "icofont icofont-student-alt"
                              })
                            ]),
                            _vm._v(" "),
                            _c("li", { staticClass: "text-right" })
        ...
        _c("ul", { staticClass: "breadcrumb-title" }, [
          _c("li", { staticClass: "breadcrumb-item" }, [
            _c("a", { attrs: { href: "index.html" } }, [
              _c("i", { staticClass: "icofont icofont-home" })
            ])
          ]),
          _vm._v(" "),
          _c("li", { staticClass: "breadcrumb-item" }, [
          ...
          _vm._v(" "),
          _c("li", { staticClass: "breadcrumb-item" }, [
            _c("a", { attrs: { href: "#!" } }, [_vm._v("Project")])
          ])
        ])
      ])
    ])
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__modal_vue__ = __webpack_require__(42);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__editModal_vue__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__editModal_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__editModal_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        ...
        editmodal: __WEBPACK_IMPORTED_MODULE_1__editModal_vue___default.a
    },
    data: function data() {
        return {
            results: [],
    ...
    methods: {
        submit: function submit() {
            ...
            if (this.loaded) {
                ...
                axios.post('/submit', this.fields).then(function (response) {
                    ...
                    _this.loaded = true;
                    _this.success = true;
                    _this.successMess = response.data.message;
                    _this.getUsers();
        ...
        edit: function edit(id) {
            ...
            axios.get('/edit/' + id).then(function (response) {
                return _this3.editresults = response.data;
            });
        },
        update: function update(id) {
            ...
            if (this.editload) {
                ...
                axios.post('/update/' + id, this.editdata).then(function (response) {
                    _this4.editsuccess = true;
                    _this4.editsuccMes = response.data.message;
                    _this4.getUsers();
                }).catch(function (error) {
                    _this4.editload = true;

                    if (error.response.status === 422) {
                        _this4.editErrors = error.response.data.errors || {};
                    }
                });
            }
        },
        delete_user: function delete_user(id) {
            ...
            axios.get('/delete/' + id).then(function (response) {
                _this5.Mess = response.data.message;
                _this5.getUsers();
            });
        },
    ...
    mounted: function mounted() {
        ...
        axios.get('/getusers').then(function (response) {
            return _this6.results = response.data;
        });
...
Component.options.__file = "resources/assets/js/views/modal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b9045aec", Component.options)
  } else {
    hotAPI.reload("data-v-b9045aec", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      attrs: { id: "sign-in-modal", tabindex: "-1" }
    },
    [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b9045aec", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/views/editModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-07194520", Component.options)
  } else {
    hotAPI.reload("data-v-07194520", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "modal fade", attrs: { id: "edit", tabindex: "-1" } },
    [
      _c("div", { staticClass: "modal-dialog", attrs: { role: "document" } }, [
        _c("div", { staticClass: "modal-content" }, [
          _c("div", { staticClass: "modal-header" }, [_vm._t("header")], 2),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-07194520", module.exports)
  }
}
            ...
            _c(
              ...
              [
                ...
                _c("div", { staticClass: "card-block" }, [
                  _c("div", { staticClass: "table-responsive" }, [
                    _c(
                      ...
                      {
                        staticClass:
                          "table table-striped table-bordered nowrap notifications"
                      },
                      [
                        _vm._m(2),
                        _vm._v(" "),
                        _vm._l(_vm.results, function(result) {
                          return _c("tbody", { key: result.id }, [
                            _c("tr", [
                              ...
                              _c("th", [
                                ...
                                _c(
                                  "button",
                                  {
                                    ...
                                    on: {
                                      click: function($event) {
                                        return _vm.delete_user(result.id)
                                      }
                                    }
                                  },
                                  [
                ...
                _c("modal", [
                  ...
                  _c(
                    "div",
                    { attrs: { slot: "body-modal" }, slot: "body-modal" },
                    [
                      _c("form", [
                        _vm.success
                          ? _c("span", { staticClass: "text-success" }, [
                              _c("h4", [_vm._v(_vm._s(_vm.successMess))])
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                        _c("div", { staticClass: "row" }, [
                          ...
                          _c("div", { staticClass: "col-sm-10" }, [
                            _c("div", { staticClass: "form-radio" }, [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "radio radiofill radio-primary radio-inline"
                                },
                                [
                                  _c("label", [
                                    _c("input", {
                                      directives: [
                                        {
                                          name: "model",
                                          rawName: "v-model",
                                          value: _vm.fields.Member,
                                          expression: "fields.Member"
                                        }
                                      ],
                                      attrs: {
                                        type: "radio",
                              ...
                              _vm._v(" "),
                              _vm.errors && _vm.errors.Member
                                ? _c("span", { staticClass: "text-danger" }, [
                                    _vm._v(_vm._s(_vm.errors.Member[0]))
                                  ])
                                : _vm._e()
                            ])
                          ])
                  ...
                  _c(
                    ...
                    [
                      _c("form", { attrs: { action: "" } }, [
                        _vm.editsuccess
                          ? _c("span", { staticClass: "text-success" }, [
                              _c("h4", [_vm._v(_vm._s(_vm.editsuccMes))])
                            ])
                          : _vm._e(),
                        _vm._v(" "),
                        _c("div", { staticClass: "row" }, [
                          _c("div", { staticClass: "col-sm-12" }, [
                            _c("div", [
                              ...
                              _c("input", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.editresults.fname,
                                    expression: "editresults.fname"
                                  }
                                ],
                                staticClass: "form-control",
                                attrs: {
                                ...
                                domProps: { value: _vm.editresults.fname },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
                              ...
                              _vm._v(" "),
                              _vm.editErrors && _vm.editErrors.firstname
                                ? _c("span", { staticClass: "text-danger" }, [
                                    _vm._v(_vm._s(_vm.editErrors.firstname[0]))
                                  ])
                                : _vm._e()
                            ])
                          ])
                          ...
                          _c("div", { staticClass: "col-sm-12" }, [
                            _c("div", [
                              ...
                              _c("input", {
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.editresults.lname,
                                    expression: "editresults.lname"
                                  }
                                ],
                                staticClass: "form-control",
                                attrs: {
                                ...
                                domProps: { value: _vm.editresults.lname },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
                              ...
                              _vm._v(" "),
                              _vm.editErrors && _vm.editErrors.lastname
                                ? _c("span", { staticClass: "text-danger" }, [
                                    _vm._v(_vm._s(_vm.editErrors.lastname[0]))
                                  ])
                                : _vm._e()
                            ])
                          ])
                          ...
                          _c("div", { staticClass: "col-sm-12" }, [
                            _c("div", [
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.editresults.email,
                                    expression: "editresults.email"
                                  }
                                ],
                                staticClass: "form-control",
                                attrs: { type: "text", name: "email", id: "" },
                                domProps: { value: _vm.editresults.email },
                                on: {
                                  input: function($event) {
                                    if ($event.target.composing) {
                                      return
                              ...
                              _vm.editErrors && _vm.editErrors.email
                                ? _c("span", { staticClass: "text-danger" }, [
                                    _vm._v(_vm._s(_vm.editErrors.email[0]))
                                  ])
                                : _vm._e()
                            ])
                          ])
                        ...
                        _c("div", { staticClass: "row" }, [
                          _c("div", { staticClass: "col-sm-6" }, [
                            _c("div", [
                                  ...
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.editdata.role,
                                      expression: "editdata.role"
                                    }
                                  ],
                                  staticClass: "form-control",
                                  attrs: { name: "role", id: "Role" },
                              ...
                              _vm._v(" "),
                              _vm.editErrors && _vm.editErrors.role
                                ? _c("span", { staticClass: "text-danger" }, [
                                    _vm._v(_vm._s(_vm.editErrors.role[0]))
                                  ])
                                : _vm._e()
                            ])
                          ])
                          ...
                          [
                            _c("input", {
                              ...
                              on: {
                                click: function($event) {
                                  $event.preventDefault()
                                  return _vm.update(_vm.editresults.id)
                                }
                              }
                            }),
                            _vm._v(" "),
      ...
      _c("div", [
        _c(
          "button",
          {
            ...
            attrs: { "data-toggle": "modal", "data-target": "#sign-in-modal" }
          },
          [_vm._v("Add Users")]
        )
      ])
